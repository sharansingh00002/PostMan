...
class _ModalBottomSheetLayout extends SingleChildLayoutDelegate {
  _ModalBottomSheetLayout(
      this.progress, this.bottomInset, this.dialogHeightPercentage);
...
class _ModalBottomSheet<T> extends StatefulWidget {
  const _ModalBottomSheet({Key key, this.route, this.dialogHeightPercentage})
      : super(key: key);
...
///
/// dialog height is a double that is ratio of screen height that dialog should have
